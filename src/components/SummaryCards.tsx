...
const SummaryCards: React.FC<SummaryCardsProps> = ({
  ...
  const familyBalance =
    Number.parseFloat(familyIncome as string) - Number.parseFloat(familyExpense as string);

  // 判断是否有家庭账单数据
  const hasFamilyData =
    Number.parseFloat(familyIncome as string) > 0 || Number.parseFloat(familyExpense as string) > 0;
        ...
        <Col span={24} md={8}>
          <Card>
            <Statistic
              ...
              precision={2}
              valueStyle={{
                color: Number.parseFloat(balance as string) >= 0 ? "#3f8600" : "#cf1322",
              }}
